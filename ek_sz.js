...
// ===== shim 结束 =====
/* 柿子 - AppV7 Lanerc source.
 * AppV7 AES 与播放解析 RSA 均由本文件本地完成，不依赖远程解密服务。 */
var SOURCE_TITLE = "柿子";
var APP_API = "http://198.16.32.131:12345/nxsz.php/v7/logs";
var APPV7_SEPARATOR = '^~!@#[-';
var APPV7_RESPONSE_MAGIC = 'eGRkYXBwc2VjcmV0a2V5'; /* base64("xddappsecretkey") */
var APPV7_KEY_HEX_FALLBACK = "cdceb3d631c85b6a5c4f949a8c2b8a64";
...
var _avConfig = {
    ...
    "name": "柿子",
    "home_url": "",
    "host": "http://198.16.32.131:12345/nxsz.php",
    "version": "2.1.1",
    "version_number": "111",
    "pk_id": "com.zxbyrk.xszi.xsza",
    "build_time": "1776949531834",
    "sign_md5": "95fd3539926fd43f1adf4edb8f1e0701",
    "apk_length": "53648920",
    "parse_key": "",
    "platform": "android",

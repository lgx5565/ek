...
// ===== shim 结束 =====
/* 粉猪 - AppV7 Lanerc source.
 * AppV7 AES 与播放解析 RSA 均由本文件本地完成，不依赖远程解密服务。 */
var SOURCE_TITLE = "粉猪";
var APP_API = "http://198.16.60.3:6688/nfenzhu.php/v7/logs";
var APPV7_SEPARATOR = '^~!@#[-';
var APPV7_RESPONSE_MAGIC = 'eGRkYXBwc2VjcmV0a2V5'; /* base64("xddappsecretkey") */
var APPV7_KEY_HEX_FALLBACK = "3a8f076274b04a2d8bd161a28c9a5477";
...
var _avConfig = {
    ...
    "name": "粉猪",
    "home_url": "",
    "host": "http://198.16.60.3:6688/nfenzhu.php",
    "version": "1.0.4",
    "version_number": "14",
    "pk_id": "com.zitibaohe.jianzhuzigejianli.szxja",
    "build_time": "1773893703246",
    "sign_md5": "d16074f47cceb00256ce9d9519d5a5c1",
    "apk_length": "56877789",
    "parse_key": "",
    "platform": "android",
    "platform_version": "TP1A.220624.014",
